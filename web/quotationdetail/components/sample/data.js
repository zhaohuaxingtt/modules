...
export const sampleTableTitle = [
  { props: "sampleType", name: "样件", tooltip: true, key: "LK_YANGJIAN",isAeko:true },
	...
	{ props: "sampleUnitPrice", name: "工装样件单件费用(RMB)", tooltip: true, key: "LK_GONGZHUANGYANGJIANDANJIANFEIYONGRMB" ,isAeko:true},
	{ props: "addionalMouldCost", name: "附加工装样件模具价格(RMB)", tooltip: true, key: "LK_FUJIAGONGZHUANGYANGJIANMUJUJIAGERMB" ,isAeko:true},
