...
export function tableTilel1Fn(level, partType,partname){
  return [
    ...
    {props:'packageCost',name:'包装费',key: 'LK_BAOZHUANGFEI',tooltip:false,width:'',type: partname === 'PT17' || partname === 'PT18' ? 'input': '' },
    {props:'transportCost',name:'运输费',key: 'LK_YUNSHUFEI',tooltip:false,width:'',type: partname === 'PT17' || partname === 'PT18' ? 'input': '' },
    {props:'operateCost',name:'操作费',key: 'LK_CAOZUOFEI',tooltip:false,width:'',type: partname === 'PT17' || partname === 'PT18' ? 'input': '' },
...
export const titleCbzzByL3 = [
  ...
  {props:'machineInvestInstall',name:'设备投资+安装（RMB）',key: 'LK_SHEBEITOUZIANZHUANGRMB',tooltip:true,width:'200',type:'input' },
  {props:'specialDeviceCost',name:'是否上汽大众专用设备费',key: 'LK_SHIFOUSHANGQIDAZHONGZHUANYONGSHEBEIFEI',tooltip:true,width:'200',type:'input' },
  {props:'perHourMachineCost',name:'设备费率（RMB/Hour）',key: 'LK_SHEBEIFEILV',tooltip:true,width:'180',type:'input'},
  {props:'perHourLaborCost',name:'直接人工费率（RMB/Hour）',key: 'LK_ZHIJIERENGONGFEILV',tooltip:true,width:'180',type:'input'},
  ...
  {props:'produceSwitchCost',name:'生产切换成本（RMB/PC.）',key: 'LK_SHENGCHANQIEHUANCHENGBEN',tooltip:true,width:'150',type:'input'},
  {props:'indirectMaterialCostGroup',name:'间接制造成本',key: 'LK_JIANJIEZHIZAOCHENGBEN',tooltip:true,width:'' ,list:[
    {props:'indirectProduceCostRate',name:'(%)',key: '',tooltip:true,width:'100',type:'input'},
