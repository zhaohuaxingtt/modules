      ...
      .then(res => {
        if (res.code == 200 && res.data) {
          if (this.userInfo.supplierId) {
            ...
            this.url = `http://10.122.44.58/sol-bnk/pages/rise/quotes/lsp-employee-view.jsf?partProjId=${ this.partInfo.projectPartId }&tmRfqId=${ this.partInfo.rfqId }&ppSupplierId=${ this.userInfo.supplierId }&ppSupplierUserId=-1&token=${ res.data }`
          }
