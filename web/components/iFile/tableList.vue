...
<template>
  <el-table
    ...
    <!----------------------支持自定义的index插槽------------------------>
    <el-table-column v-if='index' type='index' :width='indexConfig.width || 56' :align="indexConfig.width || 'center'" :header-align="indexConfig.width || 'center'" :label="indexConfig.label || indexLabel">
