export default {
  ...
  'LK_JIAGEDANWEI': '价格单位', //价格单位
  'LK_DANGQIANBANBEN': '当前版本', //当前版本
  'LK_DANGQIANLUNCI': '轮次', //轮次
  'LK_DAOCHU': '导出', //导出
  ...
  'LK_BITIANXIANGBUNENGWEIKONG': '请输入必填项', // 必填项不能为空
  'LK_JINXZRFQ': '进行中RFQ',// 进行中RFQ
  'LK_YJSRFQ': '已结束RFQ',// 进行中RFQ
  'LK_DDXLB': '定点信列表',// 进行中RFQ
  'LK_FS/GS/SPNO': 'FS/GS/SP NO.',// 进行中RFQ
  'LK_BJZT': "报价状态", //报价状态
  'LK_LCZT': '轮次状态', //轮次状态
  'LK_JIES': '接受', //接受
  'LK_LINGJBJ': '零件报价', //零件报价
  'LK_MOUJBJ': '模具报价', //模具报价
  'LK_BENLUNDATAEND': '截止日期', //本轮报价截止日
  'LK_CHANLIANGHZ': '产量汇总', //产量汇总
  'LK_BAOJIAQS': '报价趋势', //报价趋势
  'Lk_LINGJIAN': '零件', //零件
  'LK_STARTTIME': '起步生产日期', //供应商-报价详情-报价成本汇总
  'LK_CBDLINEKEY': 'CBD层级',//供应商-报价详情-CBD层级
  'LK_YIJUJUE': '已拒绝', //已拒绝
  'LK_YIBAOJIA': '已报价', //已报价
  'LK_WEIBAOJIA': '未报价', //未报价
  'LK_DIYILUN': '第一轮', //第一轮
  'LK_DIERLUN': '第二轮', //第一轮
  'LK_DISANLUN': '第三轮', //第一轮
  'LK_DISILUN': '第四轮', //第一轮
  ...
  'LK_JIAGEZHUANGTAI': '价格状态', //价格状态
  'LK_BAOJIADAN': '报价单', //报价单
  'LK_LINGJIANBAOJIAZHUANGTAI': '零件报价状态', //零件报价状态
  'LK_WULIUBAOJIAZHUANGTAI': '物流报价状态', //物流报价状态
  'LK_GONGYINGSHANGSHENGCHANGONGCHANG': '供应商生产工厂', //供应商生产工厂
  'LK_ZUIDANIANCHANLIANG': '最大年产量', //最大年产量
  'LK_PINGJUNNIANCHANLIANG': '平均年产量', //平均年产量
  'LK_SHENGMINGZHOUQIZHOU': '生命周期（周）', //生命周期（周）
  'LK_BAOZHUANGYUNSHU': '包装运输', //包装运输
  'LK_DANWEIYUAN': '(单位：元)', //(单位：元)
  'LK_BAOZHUANGFEI': '包装费', //包装费
  'LK_YUNSHUFEI': '运输费', //运输费
  'LK_CAOZUOFEI': '操作费', //操作费
  'LK_CHAKANGUANLIANLINGJIAN': '查看关联零件', //查看关联零件
  'LK_MUJUID': '模具ID', //模具ID
  'LK_ZICHANMINGCHENG': '资产名称', //资产名称

  /* quotationdetail */
  'LK_QIEHUANLINGJIAN': '切换零件', // 切换零件
  'LK_RFQGONGYINGSHANG': 'RFQ供应商', // RFQ供应商
  'LK_BAOJIALUNCI': '报价轮次', // 报价轮次
  'LK_BAOJIAJIEZHISHIJIAN': '报价截至时间', // 报价截至时间
  'LK_LINGJIANDANWEI': '零件单位', // 零件单位
  'LK_CANKAOHUILV': '参考汇率', // 参考汇率
  'LK_BAOJIARIQI': '报价日期', // 报价日期
  'LK_LIANXIREN': '联系人', // 联系人
  'LK_JUJUELIYOU': '拒绝理由', // 拒绝理由
  'LK_XUNJIABEIZHU': '询价备注', // 询价备注
  'LK_XINXIYUYAOQIU': '信息与要求', // 信息与要求
  'LK_BAOJIACHENGBENHUIZONG': '报价成本汇总', // 报价成本汇总
  'LK_GONGYINGSHANGSHENGCHANDIJISHENGCHANNENGLI': '供应商生产地及生产能力', // 供应商生产地及生产能力
  'LK_MUJUHEKAIFAFEIYONG': '模具和开发费用', // 模具和开发费用
  'LK_JIANGJIAJIHUA': '降价计划', // 降价计划
  'LK_SONGYANGJINDU': '送样进度', // 送样进度
  'LK_GONGZHUANGYANGJIAN': '工装样件', // 工装样件
  'LK_BAOJIABEIZHUYUFUJIAN': '报价备注与附件', // 报价备注与附件
  ...
  'LK_ZICHANFENLEIBIANHAOTIPS': '13：模具<br/>14：夹具<br/>15：检具<br/>16：其他工装', // 13：模具 14：夹具 15：检具 16：其他工装
  ...
  'LK_SANJIANMINGCHENGTIPS': '<p style="text-align: center">散件名称</p>', // 散件名称
  'LK_SANJIANLINGJIANHAO': '散件零件号', // 散件零件号
  'LK_SANJIANLINGJIANHAOTIPS': '<p style="text-align: center">散件零件号<br/>(若无，则用总成号)</p>', // 散件零件号 (若无，则用总成号)
  'LK_SHULIANG': '数量', // 数量
  'LK_SHULIANGTIPS': '<p style="text-align: center">必须为整数</p>', // 必须为整数
  'LK_ZICHANDANJIA': '资产单价', // 资产单价
  'LK_ZICHANDANJIATIPS': '<p style="text-align: center">不含税价格，<br/>并且保留四位小数</p>', // 不含税价格，并且保留四位小数
  'LK_ZICHANDANJIATIPS2': '<p style="text-align: center">不含税价格，<br/>并且保留两位小数</p>', // 不含税价格，并且保留两位小数
  ...
  'LK_DAXIAO': '大小', // 大小
  'LK_WENJIANDAXIAO': '文件大小', // 文件大小
  'LK_QINGXUANZEXUYAOSHANCHUDEHANG': '请选择需要删除的行', //请选择需要删除的行
  'LK_BAOJIAZHUANGTAI': '报价状态', // 报价状态
  'LK_BAOJIAJINDU': '报价进度', // 报价进度
  'LK_XUNJIACAIGOUYUAN': '询价采购员', // 询价采购员
  'LK_SHOUDONGSHURU': '手动输入', // 手动输入
  'LK_XIAZAICBD': '下载CBD', // 下载CBD
  'LK_AJIA': 'A价',// A价
  'LK_BJIA': 'B价',// B价
  'LK_LEIXING': '类型', //类型
  'LK_YUANCHANDI': '原产国', // 原产国
  'LK_SHIFOUSVWZHIDINGJIAGE': '是否SVW指定价格散件', // 是否SVW指定价格散件
  'LK_SHULIANGDANWEI': '数量单位（UoM）', // 数量单位（UoM）
  'LK_DANJIARMB': '单价', // 单价
  'LK_ZHIJIEYUANCAILIAOSANJIANCHENGBEN': '直接原材料/散件成本', // 直接原材料/散件成本
  'LK_ZHIZAOGONGXU': '制造工序', // 制造工序
  'LK_DUIYINGYUANCAILIAOSANJIAN': '对应原材料/散件（Ref.-ID）', // 对应原材料/散件
  'LK_SHEBEIMINGCHENGXINGHAO': '设备名称/型号（Ref.-Name）', // 设备名称/型号（Ref.-Name）
  'LK_SHANGQIDAZHONGZHUANYONGSHEBEIFEI': '上汽大众专用设备费', // 上汽大众专用设备费
  'LK_SHENGCHANJIEPAISEC': '生产节拍（Sec.）', // 生产节拍（Sec.）
  'LK_JIANSHUSHENGCHANJIEPAI': '件数/生产节拍（1..n）', // 件数/生产节拍（1..n）
  'LK_ZHIJIERENGONGFEILV': '直接人工费率（RMB/Hour）', // 直接人工费率（RMB/Hour）
  'LK_ZHIJIERENGONGSHULIANG': '直接人工数量（0..n）', // 直接人工数量（0..n）
  'LK_RENGONGCHENGBEN': '人工成本', // 人工成本
  'LK_RENGONGCHENGBENRMB': '人工成本（RMB/Pc.）', // 人工成本（RMB/Pc.）
  'LK_SHEBEIFEI': '设备费', // 设备费
  'LK_SHEBEIFEILV': '设备费率（RMB/Hour）', // 设备费率（RMB/Hour）
  ...
  'LK_BILI': '比例（%）', // 比例（%）
  'LK_QITAFEIYONG': '其他费用', // 其他费用
  'LK_FENTANJINE': '分摊金额（RMB/Pc.）', // 分摊金额（RMB/Pc.）
  'LK_ROUNDTYPE': '轮次状态', //轮次状态
  'LK_xxxiangx': '详细信息',
  'LK_COPE_BAOJIA': '复制报价至', //复制报价
  'LK_LIRUN': '利润', //利润
  'LK_YUANCLSJ': '原材料/散件', //原材料/散件
  'LK_YUANCLSJMS': '原材料/散件描述', //原材料/散件描述
  'LK_WULAOGLF': '物料管理费', //物料管理费
  'LK_YUANCRMBPC': '原材料/散件成本（RMB/Pc.）', //原材料/散件成本（RMB/Pc.）
  'LK_ZHIZHAOCB': '制造成本', //制造成本
  'LK_JINGEE': '金额', //金额
  'LK_FTSULIANG': '分摊数量（1..n）', // 分摊数量（1..n）
  ...
  'LK_YUANCRMBPCUP': '原材料/散件成本（RMB/PC.）', //原材料/散件成本（RMB/PC.）
