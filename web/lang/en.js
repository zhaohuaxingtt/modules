export default {
  ...
  'LK_RFQZHUANGTAI': 'rfqStats',//RFQ状态
  ...
  'LK_GONGYINGSHANGMINGCHENG': 'Supplier Name',//供应商名称
  ...
  'LK_WEIBUXITONGWENJIANWUFASHANCHU': '文件为外部系统文件, 无法删除', // 文件为外部系统文件, 无法删除
  'LK_BITIANXIANGBUNENGWEIKONG': 'Please enter required fields', // 必填项不能为空
  'LK_JINXZRFQ': 'RFQ in process',// 进行中RFQ
  'LK_YJSRFQ': 'RFQ close',// 进行中RFQ
  'LK_DDXLB': '定点信列表',// 进行中RFQ
  'LK_FS/GS/SPNO': 'FS/GS/SP NO.',// FS/GS/SP
  'LK_BJZT': "Quotation Status", //报价状态
  'LK_LCZT': 'round status',
  'LK_XIANGXX': '详细信息', //详细信息
  'LK_LINGJBJ': 'Parts Quotation', //零件报价
  'LK_MOUJBJ': 'Tooling Quotation', //模具报价
  'LK_BENLUNDATAEND': 'Deadline of current round', //本轮报价截止日
  'LK_CHANLIANGHZ': 'Volume info', //产量汇总
  'LK_BAOJIAQS': 'Quotation Tendency', //报价趋势
  'Lk_LINGJIAN': 'Parts', //零件
  'LK_STARTTIME': 'start production date', //供应商-报价详情-报价成本汇总
  'LK_CBDLINEKEY': 'CBD Level',//供应商-报价详情-CBD层级
  'LK_YIJUJUE': 'Refused', //已拒绝
  'LK_YIBAOJIA': 'Quotated', //已报价
  'LK_WEIBAOJIA': 'Unquotated', //未报价
  'LK_DIYILUN': '第一轮', //第一轮
  'LK_DIERLUN': '第二轮', //第一轮
  'LK_DISANLUN': '第三轮', //第一轮
  'LK_DISILUN': '第四轮', //第一轮
  ...
  'LK_DILIULUN': '第六轮', //第一轮
  'LK_HEJI': '合计', //合计
  'LK_QINGXUANZEXUYAOBIANJIDELINGJIAN': '请选择需要编辑的零件', //请选择需要编辑的零件
  'LK_JIAGEZHUANGTAI': 'Price Status', //价格状态
  'LK_BAOJIADAN': 'Quotation Sheet', //报价单
  'LK_LINGJIANBAOJIAZHUANGTAI': 'Quotation Status', //零件报价状态
  'LK_WULIUBAOJIAZHUANGTAI': 'BNK status', //物流报价状态
  'LK_GONGYINGSHANGSHENGCHANGONGCHANG': 'Manufacturer Site', //供应商生产工厂
  'LK_ZUIDANIANCHANLIANG': 'Peak Yearly Volume', //最大年产量
  'LK_PINGJUNNIANCHANLIANG': 'Average Yearly Volume', //平均年产量
  'LK_SHENGMINGZHOUQIZHOU': 'Leadtime (weeks)', //生命周期（周）
  'LK_BAOZHUANGYUNSHU': 'Package and Transportation', //包装运输
  'LK_DANWEIYUAN': '(单位：元)', //(单位：元)
  'LK_BAOZHUANGFEI': 'Package Cost', //包装费
  'LK_YUNSHUFEI': 'Transportation Cost', //运输费
  'LK_CAOZUOFEI': 'Operation Cost', //操作费
  'LK_MUJUID': '模具ID', //模具ID
  'LK_ZICHANMINGCHENG': '资产名称', //资产名称

  /* quotationdetail */
  'LK_QIEHUANLINGJIAN': 'Part Select', // 切换零件
  'LK_RFQGONGYINGSHANG': 'Supplier', // RFQ供应商
  'LK_BAOJIALUNCI': 'Quotation Round', // 报价轮次
  'LK_BAOJIAJIEZHISHIJIAN': 'Quotation Deadline', // 报价截至时间
  'LK_LINGJIANDANWEI': 'Part Unit', // 零件单位
  'LK_CANKAOHUILV': 'Reference ex-Rate', // 参考汇率
  'LK_BAOJIARIQI': 'Quotation Date', // 报价日期
  'LK_LIANXIREN': 'Contact', // 联系人
  'LK_JUJUELIYOU': 'Refuse Reason', // 拒绝理由
  'LK_XUNJIABEIZHU': 'Remark', // 询价备注
  'LK_XINXIYUYAOQIU': 'Information and Request', // 信息与要求
  'LK_BAOJIACHENGBENHUIZONG': 'Quotation Summary', // 报价成本汇总
  'LK_GONGYINGSHANGSHENGCHANDIJISHENGCHANNENGLI': 'Manufacturer Site and Address', // 供应商生产地及生产能力
  'LK_MUJUHEKAIFAFEIYONG': 'Tooling and Development Cost', // 模具和开发费用
  'LK_JIANGJIAJIHUA': '降价计划', // 降价计划
  'LK_SONGYANGJINDU': '送样进度', // 送样进度
  'LK_GONGZHUANGYANGJIAN': 'Prototype', // 工装样件
  'LK_BAOJIABEIZHUYUFUJIAN': '工装样件', // 报价备注与附件
  'LK_LINGJIANJIBENXINXI': '零件基本信息', // 零件基本信息
  'LK_CAIGOUXIANGMULEIXING': '采购项目类型', // 采购项目类型
  'LK_SHIFOUXINJIAN': '是否新件', // 是否新件
  'LK_SHIFOUYANYONGJIAN': '是否沿用件', // 是否沿用件
  'LK_SHIFOUGENGGAIJIAN': '是否更改件', // 是否更改件
  'LK_YUANLINGJIANHAO': '原零件号', // 原零件号
  'LK_CHANLIANGJIHUA': '产量计划', // 产量计划
  'LK_CHANLIANGJIHUATIPS': '供应商保证满足上汽大众需求产量上下浮动15%的产能', // 供应商保证满足上汽大众需求产量上下浮动15%的产能
  'LK_SOPSHIJIAN': 'SOP time', // SOP时间
  'LK_SHANGQIDAZHONGLIANXIREN': '上汽大众联系人', // 上汽大众联系人
  'LK_BUMEN': '部门', // 部门
  'LK_JUESE': '角色', // 角色
  'LK_XINGMING': '姓名', // 姓名
  'LK_DIANHUA': '电话', // 电话
  'LK_YOUXINAG': '邮箱', // 邮箱
  'LK_XIANGMUJINDU': 'Proj. Progress(Vehicle delivery time)', // 项目进度
  'LK_SHENGMINGZHOUQI': '生命周期', // 生命周期
  'LK_VFF': 'VFF', // VFF
  'LK_PVS': 'PVS', // PVS
  'LK_OS': '0S', // 0S
  'LK_SOP': 'SOP', // SOP
  'LK_BNKLINGJIANCAIGOUXIANGMUFUJIAN': 'BNK零件采购项目附件', // BNK零件采购项目附件
  'LK_WULIUXIANGGUANBNKFUJIAN': '物流相关BNK附件', // 物流相关BNK附件
  'LK_BAOJIACHENGBENHUIZONG': '报价成本汇总', // 报价成本汇总
  'LK_GONGYINGSHANGSHENGCHANDI': '供应商生产地', // 供应商生产地
  'LK_XUANZESHENGCHANGONGCHANG': '选择生产工厂', // 选择生产工厂
  'LK_GONGCHANGBIANHAO': '工厂编号', // 工厂编号
  'LK_GONGCHANGMINGCHENG': '工厂名称', // 工厂名称
  'LK_GONGCHANGJIANCHENG': '工厂简称', // 工厂简称
  'LK_GONGJIA': '国家', // 国家
  'LK_SHENGFEN': '省份', // 省份
  'LK_CHENGSHI': '城市', // 城市
  'LK_DIZHI': '地址', // 地址
  'LK_YOUBIAN': '邮编', // 邮编
  'LK_SHIFOUDINGDIAN': '是否定点', // 是否定点
  'LK_SHIFOUSHENGXIAO': '是否生效', // 是否生效
  'LK_QINGXUANZEYIGEGONGYINGSHANGGONGCHANG': '请选择一个供应商工厂', // 请选择一个供应商工厂
  'LK_SHENGCHANNENGLI': '生产能力', // 生产能力
  'LK_SHENGCHANNENGLITIPS': '上汽大众产能信息: 供应商针对此次询价车型承诺给上汽大众的产能', // 上汽大众产能信息: 供应商针对此次询价车型承诺给上汽大众的产能
  'LK_TIANJIAHANG': '添加行', // 添加行
  'LK_SHANCHUHANG': '删除行', // 删除行
  'LK_TIQIANZHUNBEIQIZHOU': '提前准备期(周)', // 提前准备期(周)
  'LK_MEIZHOUGONGZUOTIANSHU': '每周工作天数', // 每周工作天数
  'LK_MEITIANBANSHU': '每天班数', // 每天班数
  'LK_ZHOUZHENGCHANGCHANNENG': '周正常产能', // 周正常产能
  'LK_ZHOUZUIDACHANNENG': '周最大产能', // 周最大产能
  'LK_NIANZUIDAGONGZUOTIANSHU': '年最大工作天数', // 年最大工作天数
  'LK_QISHIZHOU': '起始周', // 起始周
  'LK_JIEZHIZHOU': '截止周', // 截止周
  'LK_TIQIANZHUNBEIQIZHOUBUNENGWEIKONG': '提前准备期(周)不能为空', // 提前准备期(周)不能为空
  'LK_MEIZHOUGONGZUOTIANSHUBUNENGWEIKONG': '每周工作天数不能为空', // 每周工作天数不能为空
  'LK_MEITIANBANSHUBUNENGWEIKONG': '每天班数不能为空', // 每天班数不能为空
  'LK_ZHOUZHENGCHANGCHANNENGBUNENGWEIKONG': '周正常产能不能为空', // '周正常产能不能为空
  'LK_ZHOUZUIDACHANNENGBUNENGWEIKONG': '周最大产能不能为空', // 周最大产能不能为空
  'LK_NIANZUIDAGONGZUOTIANSHUBUNENGWEIKONG': '年最大工作天数不能为空', // 年最大工作天数不能为空
  'LK_QISHIZHOUBUNENGWEIKONG': '起始周不能为空', // 起始周不能为空
  'LK_JIEZHIZHOUBUNENGXIAOYUQISHIZHOU': '截止周不能小于起始周', // 截止周不能小于起始周
  'LK_ZUIHOUYITIAOCHANNENGSHUJUDEJIEZHIZHOUBIXUWEIKONG': '最后一条产能数据的截至周必须为空', // 最后一条产能数据的截至周必须为空
  'LK_CAPACITYTIPS_1': '提前准备周期：以周为单位，是从当前加工工厂的能力水平出发，要提高到周最大产能所需要的时间(包括物料准备、人员准备等)。如果能力随时可以立即达到最大能力则此处填0；', // 提前准备周期：以周为单位，是从当前加工工厂的能力水平出发，要提高到周最大产能所需要的时间(包括物料准备、人员准备等)。如果能力随时可以立即达到最大能力则此处填0；
  'LK_CAPACITYTIPS_2': '每周工作天数：是指周正常产能条件下，每周的工作日，一般为5天；', // 每周工作天数：是指周正常产能条件下，每周的工作日，一般为5天；
  'LK_CAPACITYTIPS_3': '每周班数：是指周正常产能条件下，基于每周工作天数的每天班数；', // 每周班数：是指周正常产能条件下，基于每周工作天数的每天班数；
  'LK_CAPACITYTIPS_4': '周正常产能：正常工作班数和正常工作天数条件下，每周生产的零件数量，单位为件，请不要填写日能力或者年能力。要求周正常产能50周应不小于询价峰值年产量；', // 周正常产能：正常工作班数和正常工作天数条件下，每周生产的零件数量，单位为件，请不要填写日能力或者年能力。要求周正常产能50周应不小于询价峰值年产量；
  'LK_CAPACITYTIPS_5': '周最大产能：通过增加班数或者每周工作日天数等措施，每周最大生产的零件数量，单位为件，请不要填写日能力或者年能力，周最大产能要求至少达到周正常产能+15%；', // 周最大产能：通过增加班数或者每周工作日天数等措施，每周最大生产的零件数量，单位为件，请不要填写日能力或者年能力，周最大产能要求至少达到周正常产能+15%；
  'LK_CAPACITYTIPS_6': '年最大工作天数：是指最大产能条件下，每年的最大工作天数，单位为天；', // 年最大工作天数：是指最大产能条件下，每年的最大工作天数，单位为天；
  'LK_CAPACITYTIPS_7': '起始周：从何年何周起具备所填写的产能，可根据情况填写多条产能数据，但各条产能数据的时间需要连续，输入时间的时间格式必须为“yyyyww”六位，比如“201101”；', // 起始周：从何年何周起具备所填写的产能，可根据情况填写多条产能数据，但各条产能数据的时间需要连续，输入时间的时间格式必须为“yyyyww”六位，比如“201101”；
  'LK_CAPACITYTIPS_8': '截止周：到何年何周为止具备所填写的产能。最后一条产能数据的截至周必须为空。输入的时间格式必须为“yyyyww”六位，比如“201101”；', // 截止周：到何年何周为止具备所填写的产能。最后一条产能数据的截至周必须为空。输入的时间格式必须为“yyyyww”六位，比如“201101”；
  'LK_MUJUFEIYONG': '模具费用', // 模具费用
  'LK_DANWEI': 'Unit', // 单位 (指价格单位, *本括号内容为注释不用翻译)
  'LK_YUAN': '元', // 元 (指人民币单位, *本括号内容为注释不用翻译)
  'LK_RFQMUJUFEIYONGZONGJI': 'RFQ模具费用总计', // RFQ模具费用总计
  'LK_ZONGTOUZICHENGBEN': '总投资成本LK_ZICHANFENLEIBIANHAO', // 总投资成本LK_ZICHANFENLEIBIANHAO
  'LK_FENTANTOUZICHENGBEN': '分摊投资成本', // 分摊投资成本
  'LK_FENTANSHULIANG': '分摊数量', // 分摊数量
  'LK_DANJIANTOUZICHENGBEN': '单件投资成本', // 单件投资成本
  'LK_TIAOZHUANZHIRFQMUJUBAOJIA': '跳转至RFQ模具报价', // 跳转至RFQ模具报价
  'LK_GUANLIANLINGJIAN': '关联零件', // 关联零件
  'LK_XIAZAIMUJUCBD': '下载模具CBD', // 下载模具CBD
  'LK_SHANGCHUANBAOJIA': '上传报价', // 上传报价
  'LK_GUDINGZICHANMINGCHENG': '固定资产名称', // 固定资产名称
  'LK_GUDINGZICHANMINGCHENGTIPS': '由“零件总成名称”、“零部件名称”、“工模具种类”组成', // 由“零件总成名称”、“零部件名称”、“工模具种类”组成
  'LK_GONGYILEIXING': '工艺类型', // 工艺类型
  'LK_GONGYILEIXINGTIPS': '如注塑，冲压，电镀等', // 如注塑，冲压，电镀等
  'LK_GONGMUJUZHONGLEI': '工模具种类', // 工模具种类
  'LK_GONGMUJUZHONGLEITIPS': ' 如：热流道注塑模', // 如：热流道注塑模
  'LK_ZICHANFENLEIBIANHAO': '资产分类编号', // 资产分类编号
  'LK_ZICHANFENLEIBIANHAOTIPS': '13：模具 14：夹具 15：检具 16：其他工装', // 13：模具 14：夹具 15：检具 16：其他工装
  'LK_LINGJIANZONGCHENGMINGCHENG': '零件总成名称', // 零件总成名称
  'LK_LINGJIANZONGCHENGMINGCHENGTIPS': '一次件总成零件名称', // 一次件总成零件名称
  'LK_LINGJIANZONGCHENGLINGJIANHAO': '零件总成零件号', // 零件总成零件号
  'LK_LINGJIANZONGCHENGLINGJIANHAOTIPS': '一次件总成零件号', // 一次件总成零件号
  'LK_LINGBUJIANMINGCHENG': '零部件名称', // 零部件名称
  'LK_LINGBUJIANMINGCHENGTIPS': '散件名称', // 散件名称
  'LK_LINGBUJIANLINGJIANHAO': '零部件零件号', // 零部件零件号
  'LK_LINGBUJIANLINGJIANHAOTIPS': '散件零件号(若无，则用总成号)', // 散件零件号(若无，则用总成号)
  'LK_GONGZHUANGSHOUMING': '工装寿命', // 工装寿命
  'LK_FSNO': 'FS No.', // FS No.
  'LK_SANJIANMINGCHENG': '散件名称', // 散件名称
  'LK_SANJIANMINGCHENGTIPS': '散件名称', // 散件名称
  'LK_SANJIANLINGJIANHAO': '散件零件号', // 散件零件号
  'LK_SANJIANLINGJIANHAOTIPS': '散件零件号 (若无，则用总成号)', // 散件零件号 (若无，则用总成号)
  'LK_SHULIANG': 'Number', // 数量
  'LK_SHULIANGTIPS': '必须为整数', // 必须为整数
  'LK_ZICHANDANJIA': '资产单价', // 资产单价
  'LK_ZICHANDANJIATIPS': '不含税价格，并且保留四位小数', // 不含税价格，并且保留四位小数
  'LK_ZICHANDANJIATIPS2': '不含税价格，并且保留两位小数', // 不含税价格，并且保留两位小数
  'LK_ZICHANZONGE': '资产总额', // 资产总额
  'LK_SHIFOUFENTAN': '是否分摊', // 是否分摊
  'LK_KAIFAFEIYONG': '开发费用', // 开发费用
  'LK_RFQKAIFAFEIYONGZONGJI': 'RFQ开发费用总计', // RFQ开发费用总计
  'LK_FENTANKAIFAFEIYONG': '分摊开发费用', // 分摊开发费用
  'LK_DANJIANKAIFACHENGBEN': '单件开发成本', // 单件开发成本
  'LK_KAIFAFEIXIANGMU': '开发费项目', // 开发费项目
  'LK_MIAOSHU': '描述', // 描述
  'LK_DANJIA': '单价', // 单价
  'LK_ZONGJINE': '总金额', // 总金额
  'LK_YANGJIAN': '样件', // LK_YANGJIAN
  ...
  'LK_GONGZHUANGYANGJIANBS3': '工装样件(BS3)', // 工装样件(BS3)
  'LK_QITAYANGJIAN': '其他样件', // 其他样件
  'LK_DAXIAO': 'Size', // 大小
  'LK_WENJIANDAXIAO': 'File Size', // 文件大小
  // ---------------------------------------------end-----------------------------------------------//
  'LK_QINGXUANZEXUYAOSHANCHUDEHANG': '请选择需要删除的行', //请选择需要删除的行
  'LK_BAOJIAZHUANGTAI': 'Quotation Status', // 报价状态
  'LK_BAOJIAJINDU': 'Quotation Progress', // 报价进度
  'LK_XUNJIACAIGOUYUAN': 'Sourcer', // 询价采购员
  'LK_SHOUDONGSHURU': 'Manual Input', // 手动输入
  'LK_XIAZAICBD': 'download', // 下载CBD
  'LK_AJIA': 'A Price',// A价
  'LK_BJIA': 'B Price',// B价
  'LK_LEIXING': 'Type', //类型
  'LK_YUANCHANDI': 'Purchas. Country', // 原产国
  'LK_SHIFOUSVWZHIDINGJIAGE': 'Is Designated by SVW or not?', // 是否SVW指定价格散件
  'LK_SHULIANGDANWEI': 'Quantity Unit* (UoM)', // 数量单位（UoM）
  'LK_DANJIARMB': 'Unit Price/UoM', // 单价
  'LK_ZHIJIEYUANCAILIAOSANJIANCHENGBEN': 'Dir. Mat. Cost', // 直接原材料/散件成本
  'LK_ZHIZAOGONGXU': 'Manufacturing Method', // 制造工序
  'LK_DUIYINGYUANCAILIAOSANJIAN': 'Reference to Material/Component（Ref.-ID）', // 对应原材料/散件
  'LK_SHEBEIMINGCHENGXINGHAO': 'Machine Name / Model（Ref.-Name）', // 设备名称/型号（Ref.-Name）
  'LK_SHANGQIDAZHONGZHUANYONGSHEBEIFEI': 'SVW', // 上汽大众专用设备费
  'LK_SHENGCHANJIEPAISEC': 'Cycle Time [sec.]', // 生产节拍（Sec.）
  'LK_JIANSHUSHENGCHANJIEPAI': 'Parts per Cycle（1..n）', // 件数/生产节拍（1..n）
  'LK_ZHIJIERENGONGFEILV': 'Ø-Labor Cost [/Hour]', // 直接人工费率
  'LK_ZHIJIERENGONGSHULIANG': 'Labor Amount（0..n）', // 直接人工数量（0..n）
  'LK_RENGONGCHENGBEN': 'Labor Cost', // 人工成本
  'LK_RENGONGCHENGBENRMB': 'Labor Cost（RMB/Pc.）', // 人工成本（RMB/Pc.）
  'LK_SHEBEIFEI': 'Machine Cost', // 设备费
  'LK_SHEBEIFEILV': 'Ø-Machine Cost [/Hour]', // 设备费率
  'LK_JIANJIEZHIZAOCHENGBEN': 'Indirect Production Cost', // 间接制造成本
  'LK_SHEBEICHENGBENRMB': 'Machine Cost（RMB/Pc.）', // 设备成本（RMB/Pc.）
  'LK_BAOFEICHENGBEN': 'Scrap', // 报废成本
  'LK_BAOFEILV': 'Scrap [%]', // 报废率（%）
  'LK_JINERMB': 'Allocation（RMB/Pc.）', // 金额（RMB/Pc.）
  'LK_GUANLIFEI': 'Overhead', // 管理费
  'LK_BILI': '%', // 比例（%）
  'LK_QITAFEIYONG': 'Cost Allocation', // 其他费用
  'LK_FENTANJINE': 'Amortized Cost（RMB/Pc.）', // 分摊金额（RMB/Pc.）
  'LK_ROUNDTYPE': 'Round Type', //轮次状态
  'LK_JIES': 'Accept', //接受
  'LK_xxxiangx': 'detail information',
  'LK_COPE_BAOJIA': 'Duplicate quotation', //复制报价至
  'LK_UPLOADBJ': 'upload', //上传报价
  'LK_LIRUN': 'Profit', //利润
  'LK_YUANCLSJ': 'Mat. Cost/ Component', //原材料/散件
  'LK_YUANCLSJMS': 'Description', //原材料/散件描述
  'LK_WULAOGLF': 'material overhead', //物料管理费
  'LK_YUANCRMBPC': 'Mat. Cost/ Component（RMB/Pc.）', //原材料/散件成本（RMB/Pc.） 
  'LK_ZHIZHAOCB': 'Prod. Cost', //制造成本
  'LK_JINGEE': 'Allocation', //金额
  'LK_FTSULIANG': 'Amortized Quantity（1..n）', // 分摊数量（1..n）
  ...
  'LK_MEIMUSHENGCHANLINGJIANSHU': '每模生产零件数（per cycle）', // 每模生产零件数
