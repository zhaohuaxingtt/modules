...
export const moduleCostTableTitle = [
  ...
  { props: 'assembledPartName', name: '零件总成名称', tooltip: true, width: 110, key: "LK_LINGJIANZONGCHENGMINGCHENG", tipsKey: "LK_LINGJIANZONGCHENGMINGCHENGTIPS", /* tips: "<p style='text-align: center'>一次件总成零件名称</p>" */ },
  { props: 'assembledPartCode', name: '零件总成零件号', tooltip: true, width: 150, key: "LK_LINGJIANZONGCHENGLINGJIANHAO", tipsKey: "LK_LINGJIANZONGCHENGLINGJIANHAOTIPS", /* tips: "<p style='text-align: center'>一次件总成零件号</p>" */ },
  ...
  { props: 'supplierPartCodeList', name: '零部件零件号', tooltip: true, width: 110, key: "LK_LINGBUJIANLINGJIANHAO", tipsKey: "LK_LINGBUJIANLINGJIANHAOTIPS", /* tips: "<p style='text-align: center'>散件零件号<br/>(若无，则用总成号)</p>" */ },
  ...
  { props: 'assetUnitPrice', name: '资产单价', tooltip: true, width: 90, key: "LK_ZICHANDANJIA", tipsKey: "LK_ZICHANDANJIATIPS2", /* tips: "<p style='text-align: center'>不含税价格，<br/>并且保留两位小数</p>" */ },
