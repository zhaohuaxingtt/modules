...
export const moduleCostTableTitle = [
  ...
  { props: 'fixedAssetsName', name: '固定资产名称', tooltip: true, width: 120, key: "LK_GUDINGZICHANMINGCHENG", tipsLang: true, tipsKey: "LK_GUDINGZICHANMINGCHENGTIPS", tips: "<p style='text-align: center'>由“零件总成名称”、“零部件名称”、<br/>“工模具种类”组成</p>" },
  { props: 'stuffType', name: '工艺类型', tooltip: true, width: 90, key: "LK_GONGYILEIXING", tipsLang: true, tipsKey: "LK_GONGYILEIXINGTIPS", tips: "如注塑，冲压，电镀等" },
  { props: 'mouldType', name: '工模具种类', tooltip: true, width: 110, key: "LK_GONGMUJUZHONGLEI", tipsLang: true, tipsKey: "LK_GONGMUJUZHONGLEITIPS", tips: "如：热流道注塑模" },
  ...
  { props: 'assetUnitPrice', name: '资产单价', tooltip: true, width: 90, key: "LK_ZICHANDANJIA", tipsLang: true, tipsKey: "LK_ZICHANDANJIATIPS2", tips: "<p style='text-align: center'>不含税价格，<br/>并且保留两位小数</p>" },
